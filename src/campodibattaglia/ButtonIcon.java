...
public class ButtonIcon extends JButton {
    ...
    ButtonIcon(int nFinestra, double Width, double Height) {
        ...
        if (nFinestra == 1){
            ...
            setBounds((int)(screenWidth / 2 - (0.1171875*screenWidth)), (int)(screenHeight / 2 + (0.092592592592593*screenHeight)), x,y);
            ...
            setBounds((int)(screenWidth / 2 - (0.1171875*screenWidth)), (int)(screenHeight / 2 + (0.185185185185185*screenHeight)), x,y);
            ...
            setBounds((int)(screenWidth / 2 - (0.208333333333333*screenWidth)), (int)(screenHeight / 2 - (0.092592592592593*screenHeight)), x, y);
            ...
            setBounds((int)(screenWidth / 2 + (0.052083333333333*screenWidth)), (int)(screenHeight / 2 - (0.092592592592593*screenHeight)), x, y);
